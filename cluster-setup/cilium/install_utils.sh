...
# Install bom
curl -L https://github.com/kubernetes-sigs/bom/releases/download/v0.7.1/bom-amd64-linux > bom-amd64-linux
chmod +x bom-amd64-linux
mv bom-amd64-linux /usr/local/bin/bom

# Install Kube-bench
curl -L https://github.com/aquasecurity/kube-bench/releases/download/v0.13.0/kube-bench_0.13.0_linux_amd64.deb -o kube-bench_0.13.0_linux_amd64.deb
apt install ./kube-bench_0.13.0_linux_amd64.deb -f
rm kube-bench_0.13.0_linux_amd64.deb
